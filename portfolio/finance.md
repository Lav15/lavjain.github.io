...
<p style="margin-top:-8px;"><strong>Investment Banking | UK</strong></p>
...
* **Stakeholders:** Head of Market Risk Reporting, Market Risk executives, and IT/DBA teams.
...
* **Stakeholders:** Group Controller, Regional Finance Managers, and ERP Technical Leads.
...
* **Execution:**
    * Architected a unified data model that ingested and reconciled heterogeneous data structures from four distinct ERP environments and external sources.
...
* **Stakeholders:** Senior executives from Treasury.
...
* **Execution:**
    * Designed a consolidated data model capturing the full lifecycle of corporate loans, with the ability to distinguish between fixed and floating interest structures.
...
* **Stakeholders:** Group Consolidation Manager & Financial Controller
...
* **Execution:**
    ...
    * Performed financial data validation with stakeholders to ensure 100% reconciliation between source ERP systems and the BI reporting layer.
